...
class GarminClientTestCase(unittest.TestCase):
    _ANY_WORKOUT: list[dict[str, str]] = [{"foo1": "bar1"}]
    ...
    def test_list_workouts(self) -> None:
        batch_size = 10
        any_workouts: list[dict[str, str]] = [{"foo1": "bar1"}, {"foo2": "bar2"}]
        empty_response: list = []

        url: str = f"{GarminClient._WORKOUT_SERVICE_ENDPOINT}/workouts"
        params1: dict[str, str] = {"start": str(0), "limit": str(batch_size)}
        params2: dict[str, str] = {"start": str(batch_size), "limit": str(batch_size)}
    ...
    def test_list_workouts_error_handling(self) -> None:
        batch_size = 10

        url: str = f"{GarminClient._WORKOUT_SERVICE_ENDPOINT}/workouts"
        params: dict[str, str] = {"start": str(0), "limit": str(batch_size)}
    ...
    def test_get_workout(self) -> None:
        workout_id = 1
    ...
    def test_get_workout_error_handling(self) -> None:
        workout_id = 1
    ...
    def test_download_workout_error_handling(self) -> None:
        workout_id = 1
        file = "workout.fit"
    ...
    def test_save_workout_error_handling(self) -> None:
        url: str = f"{GarminClient._WORKOUT_SERVICE_ENDPOINT}/workout"
        self.httpserver \
            .expect_request(url, method="POST", json=GarminClientTestCase._ANY_WORKOUT) \
    ...
    def test_update_workout_error_handling(self) -> None:
        workout_id = 1
    ...
    def test_delete_workout_error_handling(self) -> None:
        workout_id = 1
    ...
    def test_schedule_workout(self) -> None:
        workout_id = 1
        date = "any date"
    ...
    def test_schedule_workout_error_handling(self) -> None:
        workout_id = 1
        date = "any date"
