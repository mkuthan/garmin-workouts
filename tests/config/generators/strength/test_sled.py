...
@pytest.mark.parametrize("generator, exercise_name, execution", [
    (backward_drag_rep_generator, 'BACKWARD_DRAG', 'reps'),
    (backward_drag_hold_generator, 'BACKWARD_DRAG', 'hold'),
    (chest_press_rep_generator, 'CHEST_PRESS', 'reps'),
    (chest_press_hold_generator, 'CHEST_PRESS', 'hold'),
    (forward_drag_rep_generator, 'FORWARD_DRAG', 'reps'),
    (forward_drag_hold_generator, 'FORWARD_DRAG', 'hold'),
    (low_push_rep_generator, 'LOW_PUSH', 'reps'),
    (low_push_hold_generator, 'LOW_PUSH', 'hold'),
    (push_rep_generator, 'PUSH', 'reps'),
    (push_hold_generator, 'PUSH', 'hold'),
