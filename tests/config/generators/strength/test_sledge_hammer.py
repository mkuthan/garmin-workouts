...
@pytest.mark.parametrize("generator, exercise_name, execution", [
    (lateral_swing_rep_generator, 'LATERAL_SWING', 'reps'),
    (lateral_swing_hold_generator, 'LATERAL_SWING', 'hold'),
    (hammer_slam_rep_generator, 'HAMMER_SLAM', 'reps'),
    (hammer_slam_hold_generator, 'HAMMER_SLAM', 'hold'),
    (sledge_hammer_rep_generator, 'SLEDGE_HAMMER', 'reps'),
    (sledge_hammer_hold_generator, 'SLEDGE_HAMMER', 'hold'),
    ])
