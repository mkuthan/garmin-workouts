...
@pytest.mark.parametrize("generator, exercise_name, execution", [
    (around_the_world_rep_generator, 'AROUND_THE_WORLD', 'reps'),
    (around_the_world_hold_generator, 'AROUND_THE_WORLD', 'hold'),
    (back_squat_rep_generator, 'BACK_SQUAT', 'reps'),
    (back_squat_hold_generator, 'BACK_SQUAT', 'hold'),
    (bear_crawl_pull_through_rep_generator, 'BEAR_CRAWL_PULL_THROUGH', 'reps'),
    (bear_crawl_pull_through_hold_generator, 'BEAR_CRAWL_PULL_THROUGH', 'hold'),
    (bear_hug_squat_rep_generator, 'BEAR_HUG_SQUAT', 'reps'),
    (bear_hug_squat_hold_generator, 'BEAR_HUG_SQUAT', 'hold'),
    ...
    (front_carry_rep_generator, 'FRONT_CARRY', 'reps'),
    (front_carry_hold_generator, 'FRONT_CARRY', 'hold'),
    (front_squat_rep_generator, 'FRONT_SQUAT', 'reps'),
    (front_squat_hold_generator, 'FRONT_SQUAT', 'hold'),
    (lunge_rep_generator, 'LUNGE', 'reps'),
    (lunge_hold_generator, 'LUNGE', 'hold'),
    (overhead_press_rep_generator, 'OVERHEAD_PRESS', 'reps'),
    (overhead_press_hold_generator, 'OVERHEAD_PRESS', 'hold'),
    (plank_pull_through_rep_generator, 'PLANK_PULL_THROUGH', 'reps'),
    (plank_pull_through_hold_generator, 'PLANK_PULL_THROUGH', 'hold'),
    (rotational_lunge_rep_generator, 'ROTATIONAL_LUNGE', 'reps'),
    (rotational_lunge_hold_generator, 'ROTATIONAL_LUNGE', 'hold'),
    ...
    (shouldering_rep_generator, 'SHOULDERING', 'reps'),
    (shouldering_hold_generator, 'SHOULDERING', 'hold'),
    (shoveling_rep_generator, 'SHOVELING', 'reps'),
    (shoveling_hold_generator, 'SHOVELING', 'hold'),
