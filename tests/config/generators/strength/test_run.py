...
@pytest.mark.parametrize("generator, exercise_name, execution", [
    (jog_rep_generator, 'JOG', 'reps'),
    (jog_hold_generator, 'JOG', 'hold'),
    (run_rep_generator, 'RUN', 'reps'),
    (run_hold_generator, 'RUN', 'hold'),
    (run_or_walk_rep_generator, 'RUN_OR_WALK', 'reps'),
    (run_or_walk_hold_generator, 'RUN_OR_WALK', 'hold'),
    (sprint_rep_generator, 'SPRINT', 'reps'),
    (sprint_hold_generator, 'SPRINT', 'hold'),
    (walk_rep_generator, 'WALK', 'reps'),
    (walk_hold_generator, 'WALK', 'hold'),
    ])
