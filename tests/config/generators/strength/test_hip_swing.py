...
@pytest.mark.parametrize("generator, exercise_name, execution", [
    (hip_swing_rep_generator, 'HIP_SWING', 'reps'),
    (hip_swing_hold_generator, 'HIP_SWING', 'hold'),
    (one_arm_swing_rep_generator, 'ONE_ARM_SWING', 'reps'),
    (one_arm_swing_hold_generator, 'ONE_ARM_SWING', 'hold'),
    (single_arm_dumbbell_swing_rep_generator, 'SINGLE_ARM_DUMBBELL_SWING', 'reps'),
    (single_arm_dumbbell_swing_hold_generator, 'SINGLE_ARM_DUMBBELL_SWING', 'hold'),
    (single_arm_kettlebell_swing_rep_generator, 'SINGLE_ARM_KETTLEBELL_SWING', 'reps'),
    (single_arm_kettlebell_swing_hold_generator, 'SINGLE_ARM_KETTLEBELL_SWING', 'hold'),
    (step_out_swing_rep_generator, 'STEP_OUT_SWING', 'reps'),
    (step_out_swing_hold_generator, 'STEP_OUT_SWING', 'hold'),
    ])
