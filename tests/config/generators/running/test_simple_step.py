...
@pytest.mark.parametrize("generator, duration, expected", [
    ...
    (R1p_step_generator, 30, {'type': 'interval', 'duration': 30, 'target': 'R1+', 'description': 'R1+ pace zone',
                              'category': None, 'exerciseName': None}),
    ...
    (R3_step_generator, 50, {'type': 'interval', 'duration': 50, 'target': 'R3', 'description': 'R3 pace zone',
                             'category': None, 'exerciseName': None}),
    (R3p_step_generator, 60, {'type': 'interval', 'duration': 60, 'target': 'R3+', 'description': 'R3+ pace zone',
                              'category': None, 'exerciseName': None}),
